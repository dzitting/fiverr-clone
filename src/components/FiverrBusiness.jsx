    ...
    return (
        <div className="bg-[#0d084d]" px-20 py-16 flex gap-10>
            <div className="text-white flex flex-col gap-6 justify-center items-start">
                ...
                <button className="border text-base font-medium px-5 py-2 border-[#1d8f73] bg-[#1d8f73] text-white"
                    type="button">
                        Explore Fiverr Business </button>
            </div>
            <div className="relative h-[512px] w-2/3">
                <Image src="/business.webp" fill alt="business" />
            </div>
        </div>
    );
}
